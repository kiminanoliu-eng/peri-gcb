    ...
    if image_url:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"❌ 图片URL无效 (状态码: {response.status_code})")
        except Exception as e:
        ...
        if project_image:
            try:
                ...
                if response.status_code == 200:
                    ...
                    print(f"  ❌ 项目图片无效 (状态码: {response.status_code})")
            except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'pdf' in content_type.lower():
                    ...
                    print(f"⚠️  Content-Type不是application/pdf: {content_type}")
            else:
                errors.append(f"PDF链接无效 (状态码: {response.status_code}): {pdf_link}")
                print(f"❌ PDF链接无效 (状态码: {response.status_code})")
        except Exception as e:
